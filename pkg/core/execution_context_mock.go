...
// BinaryMode provides a mock function with given fields: initBuffer
func (_m *MockExecutionContext) BinaryMode(initBuffer string) (string, error) {
	ret := _m.Called(initBuffer)

	if len(ret) == 0 {
		panic("no return value specified for BinaryMode")
	}
...
// MockExecutionContext_BinaryMode_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'BinaryMode'
type MockExecutionContext_BinaryMode_Call struct {
	*mock.Call
}

// BinaryMode is a helper method to define mock.On call
//   - initBuffer string
func (_e *MockExecutionContext_Expecter) BinaryMode(initBuffer interface{}) *MockExecutionContext_BinaryMode_Call {
	return &MockExecutionContext_BinaryMode_Call{Call: _e.mock.On("BinaryMode", initBuffer)}
}

func (_c *MockExecutionContext_BinaryMode_Call) Run(run func(initBuffer string)) *MockExecutionContext_BinaryMode_Call {
...
func (_c *MockExecutionContext_BinaryMode_Call) Return(_a0 string, _a1 error) *MockExecutionContext_BinaryMode_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockExecutionContext_BinaryMode_Call) RunAndReturn(run func(string) (string, error)) *MockExecutionContext_BinaryMode_Call {
	_c.Call.Return(run)
	return _c
}
